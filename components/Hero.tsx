    ...
    <div className="w-full bg-white pt-32 pb-16 md:pt-48 md:pb-24">
      <div className="container mx-auto px-6 md:px-12 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <button className="px-8 py-3.5 bg-brand-gold hover:bg-brand-blue text-white font-semibold tracking-wide transition-all duration-300 rounded-sm text-sm">
            Our Expertise
          </button>
          <button className="px-8 py-3.5 border border-brand-blue text-brand-blue hover:bg-brand-blue hover:text-white font-semibold tracking-wide transition-all duration-300 rounded-sm text-sm">
            Contact Us
          </button>
        </div>
      </div>
